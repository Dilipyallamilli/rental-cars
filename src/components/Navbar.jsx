  ...
  return (
    <header className="max-w-[1400px]  mx-auto relative">
      <div className="fixed top-0  z-20 flex justify-between w-full h-20 p-4 mx-auto mb-4 bg-white lg:px-12 max-w-[1400px] ">
        {/* LOGO */}
        <div>
          <h2 className="text-2xl font-extrabold text-red-700"> Rental-Car's</h2>
        </div>
        {/*  navbar */}
          ...
          <ul className="hidden gap-4 sm:flex">
            ...
            <li>
              <Link to="/bookings" className="relative text-base font-semibold">
                <div className="absolute right-[-35px] opacity-80  bg-green-500 border-2  rounded-[100%] top-[-2px] px-2 text-sm">
                  {bookings.length}
                </div>
                Booking's
              </Link>
