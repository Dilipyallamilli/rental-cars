      ...
      <div className="w-full sm:w-[60%]">
        <div className="flex flex-col justify-center h-full">
          <h3 className="text-xl font-bold text-red-700 sm:text-2xl">
            Download Rental-Car App
          </h3>
          <h4 className="text-base font-semibold text-gray-700 ">
            Rental-Car is your one-stop online destination for all your automotive
            ...
            repairing, or sourcing genuine car parts, Rental-Car's has you covered.
          </h4>
