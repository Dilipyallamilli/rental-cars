...
import { ferrariRed, hyundai, yellowFerrari } from "./Index";
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full mx-auto sm:h-[300px] h-[200px]">
        <img src={hyundai} alt="banner" className="object-contain " />
      </div>
      {/* description about carvala */}
      <div className="flex flex-col justify-center gap-2 ">
        <h3 className="text-xl font-bold text-blue-700 sm:text-2xl">
          Our Luxury Service's
        </h3>
        <h3 className="text-base font-semibold text-gray-700">
           Rental Caris a premium car rental platform that offers more than just
